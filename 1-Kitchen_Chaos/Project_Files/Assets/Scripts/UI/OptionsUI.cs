...
public class OptionsUI : MonoBehaviour
{
    ...
    {
        soundEffectsText.text = "Sound Effects Level: " + Mathf.Round(SoundManager.Instance.GetVolume() * 10f);
        musicText.text = "Music Level: " + Mathf.Round(MusicManager.Instance.GetVolume() * 10f);
